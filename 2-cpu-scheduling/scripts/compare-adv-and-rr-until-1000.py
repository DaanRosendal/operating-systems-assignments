...
This script compares the priority scheduling algorithm with the round robin algorithm until a
problem size of 1000.
"""
...
# Generate specific problem sizes: 100, 200, 300, ..., up to 1000
...
# Define the problem sizes: 100, 200, ..., up to 1000
