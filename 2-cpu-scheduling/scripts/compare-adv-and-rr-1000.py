...
problem sizes (steps of 1000) and configurations. The priority scheduling algorithm is tested with a
specific aging time interval and aging factor. The round robin algorithm is tested with the same
problem sizes.
"""
...
# Generate specific problem sizes: 100, 1000, 2000, 3000, ..., up to 40960
def generate_custom_values():
    values = [100]  # Starting value
    values.extend(range(1000, 40961, 1000))  # Range starting at 1000 with increments of 1000
    return values
...
# Define the problem sizes: 100, 1000, 2000, ..., up to 40960
p_values = generate_custom_values()

# add 40960 to the list of problem sizes
p_values.append(40960)
